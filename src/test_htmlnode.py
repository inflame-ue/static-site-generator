...
class TestTextToHTML(unittest.TestCase):
    ...
    def test_link(self):
        node = TextNode("This is a link node", TextType.LINK_TEXT, url="https://example.com")
        html_node = text_node_to_html_node(node)
    ...
    def test_image(self):
        node = TextNode("This is an image node", TextType.IMAGE_TEXT, url="https://example.com")
        html_node = text_node_to_html_node(node)
